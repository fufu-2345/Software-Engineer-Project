...
const RegisterNonClub = () => {
    ...
    return (
      ...
      {/* Username error popup */}
      <Popup open={usernameErrorStatus} onClose={() => setUserNameErrorStatus(false)} modal>
                <div>
                    <p>This Username is already in use.</p>
                    <button onClick={() => setUserNameErrorStatus(false)}>Close</button>
                </div>
            </Popup>
            <Popup open={accnameErrorStatus} onClose={() => setAccNameErrorStatus(false)} modal>
                <div>
            ...
            <Popup open={otpSentErrorStatus} onClose={() => setOtpSentErrorStatus(false)} modal>
                <div>
            ...
            {/* OTP entry popup */}
            <Popup open={otpEnterStatus} onClose={() => setotpEnterStatus(false)} modal>
                <div>
